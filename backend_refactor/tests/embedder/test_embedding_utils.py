...
from backend_refactor.embedder.embedding_utils import embed_chunks, _load_json_file
...
def test_embed_chunks_logging(mock_client, temp_json_file, temp_log_file, caplog):
    ...
    with patch("backend_refactor.embedder.embedding_utils.logger") as mock_logger:
