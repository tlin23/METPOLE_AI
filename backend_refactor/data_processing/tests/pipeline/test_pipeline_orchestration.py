...
from backend_refactor.data_processing.pipeline.pipeline_orchestration import (
    crawl_content,
    parse_files,
...
from backend_refactor.data_processing.pipeline.directory_utils import get_step_dir
from backend_refactor.data_processing.models.content_chunk import ContentChunk
...
def parser_map_patch(mock_parser_class):
    ...
    return patch(
        "backend_refactor.data_processing.pipeline.pipeline_orchestration.PARSER_MAP",
...
@patch("backend_refactor.data_processing.pipeline.pipeline_orchestration.WebCrawler")
...
@patch("backend_refactor.data_processing.pipeline.pipeline_orchestration.LocalCrawler")
...
@patch(
    "backend_refactor.data_processing.pipeline.pipeline_orchestration.clean_pipeline"
)
@patch("backend_refactor.data_processing.pipeline.pipeline_orchestration.embed_chunks")
...
@patch("backend_refactor.data_processing.pipeline.pipeline_orchestration.crawl_content")
@patch("backend_refactor.data_processing.pipeline.pipeline_orchestration.sort_files")
@patch("backend_refactor.data_processing.pipeline.pipeline_orchestration.parse_files")
@patch(
    "backend_refactor.data_processing.pipeline.pipeline_orchestration.embed_chunks_from_dir"
)
