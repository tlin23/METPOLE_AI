...
HTML_DIR = "backend_legacy/data/html"
INDEX_DIR = "backend_legacy/data/index"
PROCESSED_DIR = "backend_legacy/data/processed"
...
OFFLINE_DOCS_DIR = "backend_legacy/data/offline_docs"
...
DOC_TEXT_DIR = "backend_legacy/data/doc_text"
