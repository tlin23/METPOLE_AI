...
from backend_legacy.api.models import ChunkResult
from backend_legacy.retriever.ask import Retriever
...
@patch("backend_legacy.retriever.ask.chromadb.PersistentClient")
@patch("backend_legacy.retriever.ask.OpenAI")
...
def test_generate_answer_with_flags(sample_chunks, tmp_retriever):
    with patch.object(
        ...
        "backend_legacy.retriever.ask.client.chat.completions.create"
    ) as mock_create:
