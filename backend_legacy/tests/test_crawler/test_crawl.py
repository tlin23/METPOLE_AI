...
from backend_legacy.crawler import crawl
import tempfile


@patch("backend_legacy.crawler.crawl.requests.get")
...
@patch(
    "backend_legacy.crawler.crawl.requests.get",
...
@patch(
    "backend_legacy.crawler.crawl.fetch_url",
