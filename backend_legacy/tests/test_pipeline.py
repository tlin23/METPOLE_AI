...
from backend_legacy.online_content_pipeline import run_pipeline, HTML_DIR


@patch("backend_legacy.online_content_pipeline.recursive_crawl")
@patch("backend_legacy.online_content_pipeline.process_html_files")
@patch("backend_legacy.online_content_pipeline.embed_corpus_data")
